        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              {navLinks.map(({ href, label }) => (
                <a key={href} href={href} className="text-slate-300 hover:text-emerald-400 transition">
                  {label}
                </a>
              ))}
            </div>
            <button
              type="button"
              className="md:hidden text-slate-300 p-2 -mr-2 rounded-lg hover:bg-slate-800 transition"
          ...
          <div
            ...
            className={`md:hidden overflow-hidden transition-[max-height] duration-200 ease-out ${
              mobileMenuOpen ? 'max-h-80 border-t border-slate-800' : 'max-h-0'
            }`}
          >
            <div className="flex flex-col gap-1 py-3">
              {navLinks.map(({ href, label }) => (
                <a
                  key={href}
                  href={href}
                  className="text-slate-300 hover:text-emerald-400 transition py-2 px-2 rounded-lg hover:bg-slate-800"
          ...
          <div className="flex flex-col md:flex-row gap-12">
            <div className="md:w-1/2">
              ...
              <div className="mt-8 flex space-x-4">
                <a href="https://github.com/AliHaider111" className="p-2 bg-slate-800 hover:bg-slate-700 rounded-full transition">
